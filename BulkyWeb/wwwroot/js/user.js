                ...
                "render": function (data) {
                    ...
                    if (lockout > today) {
                        return '<div class="text-center">' +
                            ...
                            '<a href="/admin/user/RoleManagement?userId=' + data.id + '" class="btn btn-danger text-white" style="cursor:pointer; width:120px;"> <i class="bi bi-pencil-square"></i>Permission</a>' +
                            '</div >'
                    }
                    else {
                        return '<div class="text-center">' +
